...
24 个活跃会话保持单会话 1 秒节奏。吞吐继续下降时先检查官方响应时延、Mongo 写入和门禁指标；只有连续多轮出现同型资源保护停轮，才允许按实测结果收紧这个硬上限。
